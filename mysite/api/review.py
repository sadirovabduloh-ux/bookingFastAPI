...
@review_router.get('/{review.id}/',response_model=ReviewOutSchema)
...
@review_router.put('/{review.id}/',response_model=dict)
...
@review_router.delete('/{review.id}/',response_model=dict)
